...
export const GRAVITE = {
  ...
  2: { bg: '#fef9c3', bd: '#eab308', tx: '#854d0e', lb: 'Modéré' },
...
export const RECO = {
  ...
  investigation: { label: 'Investigation complémentaire', icon: '🔬' },
  travaux_legers: { label: 'Travaux légers', icon: '🔧' },
  travaux_lourds: { label: 'Travaux lourds', icon: '🏗' },
  mise_en_securite: { label: 'Mise en sécurité immédiate', icon: '🚨' },
};
...
export const GRAV_OPTIONS = [
  { v: 1, l: '1 — Mineur' },
  { v: 2, l: '2 — Modéré' },
  { v: 3, l: '3 — Significatif' },
  { v: 4, l: '4 — Critique' },
];

export const EVO_OPTIONS = [
  { v: 'stable', l: 'Stable' },
  { v: 'evolutif', l: 'Évolutif' },
  { v: 'urgent', l: 'Urgent' },
];

export const IMPACT_OPTIONS = [
  { v: 'esthetique', l: 'Esthétique' },
  { v: 'fonctionnel', l: 'Fonctionnel' },
  { v: 'structurel', l: 'Structurel' },
];

export const RECO_OPTIONS = [
  { v: 'surveillance', l: 'Surveillance' },
  { v: 'investigation', l: 'Investigation' },
  { v: 'travaux_legers', l: 'Travaux légers' },
  { v: 'travaux_lourds', l: 'Travaux lourds' },
  { v: 'mise_en_securite', l: 'Mise en sécurité' },
];
